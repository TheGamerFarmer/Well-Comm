...
export default function ProfilAide() {
    return (
        ...
        <div className="mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
            ...
            <div>
        <div className="w-[1095px] h-[66px] mb-[22px] pt-4 pr-[843px] pb-4 pl-[23px] bg-gradient-to-r from-blue-400 to-blue-700">
            ...
            <form className="mx-auto max-w-md">
                ...
                <textarea className="h-[50px] self-stretch flex flex flex-row justify-between items-start py-[14px] ph-4 rounded-lg border #dfdfdf border-solid bg-[#fff]h-10 rounded-lg border-2 border-[#dfdfdf] mb-4 mt-1 p-3 text-black"></textarea>
